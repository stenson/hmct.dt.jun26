...
def shortcuts(r:Rect):
    ...
    return (P(
        StSt("For today’s HMCT workshop", "FrankfurterEF-Highlight", 24, multiline=1).xalign(r),
        StSt("Dimensional\nTypography", "Bombere", 82).xalign(r)
            .append(lambda p: StSt("“", f:="Gooper5-Super", 100).align(p.ambit(), "W").shift(-2, 0))
            .append(lambda p: StSt("”", "Gooper5-Super", 100).align(p.ambit(), "E").shift(2, 0)),
        ...
        P(Rect(0, 9, 800, 4)).addFrame(Rect(0, 0, 800, 24)).xalign(r),
        P(
        ...
        P(Rect(0, 6, 800, 4)).addFrame(Rect(0, 0, 800, 18)).xalign(r),
        StSt("June 2026 • Pasadena, California", "CaslonSansShaded-No1", 24, multiline=1, EDPT=1, tu=100, EHLT=0, case="upper").xalign(r),
        )
        .f(0)
        .stack(40)
        .align(r)
